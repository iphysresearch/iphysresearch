...
* [TOP250movie_douban](https://github.com/iphysresearch/TOP250movie_douban) **759⭐, 184** forks (TOP250豆瓣电影短评：Scrapy 爬虫+数据清理/分析+构建中文文本情感分析模型) 
* [GWData-Bootcamp](https://github.com/iphysresearch/GWData-Bootcamp) **54⭐, 136** forks (Gravitational Wave Data Exploration: A Practical Training in...) 
